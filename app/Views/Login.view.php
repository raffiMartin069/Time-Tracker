...
<head>
  ...
  <link rel="stylesheet" href="<?php echo ROOT?>css/login-media.css" />
...
<body>
  <div id="form-wrapper" class="d-flex align-items-center justify-content-center vh-100">
    <form id="login-form" method="POST">
      ...
      <?php endif; ?>
      <div>
        <img src="<?php echo ROOT?>assets/img/logo_wtn.png" alt="WhereToNext Logo" style="max-width: 30%" class="d-flex m-auto mt-4" />
      </div>
      ...
      <div class="form-outline mb-4 position-relative">
        ...
        <img id="login-img" src="<?php echo ROOT?>assets/img/person.png" alt="..." style="
              max-width: 1.3rem;
              position: absolute;
              right: 10px;
              top: 50%;
      ...
      <div class="form-outline mb-4 position-relative">
        ...
        <img id="view-pass" src="<?php echo ROOT?>assets/img/view-pass.png" alt="..." style="
              max-width: 1.3rem;
              position: absolute;
              right: 10px;
              top: 0%;
            ...
            " />
        <img id="view" src="<?php echo ROOT?>assets/img/view.png" alt="..." style="position: absolute; right: 8px; top: 30%; max-width: 1.6rem" />
      </div>
  ...
  <script src="<?php echo ROOT?>scripts/login.js"></script>
</body>
</html>