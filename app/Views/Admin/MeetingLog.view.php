        ...
        <div class="m-2 mt-3 rounded p-2 shadow-sm">
            <form class="container d-lg-flex" id="search-form">
                <div class="search-container w-100">
                    ...
                    <input class="form-control border bg-light mr-sm-1 w-auto search-input" id="searchInput" type="search"
                            ...
                            <table class="table align-middle mb-0 bg-white text-center">
                                ...
                                <tbody id="tableBody">
                                    <?php foreach ($tableView as $view): ?>
                                        <tr class="table-row">
                                        <td><?php echo htmlspecialchars($view->meeting_id ?? "", ENT_QUOTES, 'UTF-8'); ?></td>
                                        ...
                                        <td><?php echo htmlspecialchars($view->meeting_title ?? "", ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td><?php echo htmlspecialchars($view->start_meeting ?? "", ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td><?php echo htmlspecialchars($view->end_meeting ?? "", ENT_QUOTES, 'UTF-8'); ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
