...
<body>
                            ...
                            <?php if (!empty($results) && is_array($results)) : ?>
                                ...
                                ?>
                                    <tr class="employee-record" data-date="<?php echo $reportDate; ?>">
                                        <td hidden><?php echo $report->getWKLYID(); ?></td>
                                        ...
                                        <td class="fixed-height">
                                            <button type="submit" class="btn clickMyDots" id="previewBtn" style="width: 2.4rem; height: 2.05rem; border: none; border-radius: 0; border-right: none !important; margin-right: -5px !important; background-color: #F9F9F9; border: 1.5px solid #DDDDDD; border-top-left-radius: 5px; border-bottom-left-radius: 5px;">
                                            ...
                                            <form action="Admin/employeeWeeklyReport" method="post" target="_blank" class="weeklyDownload" style="display:inline;">
                                                ...
                                                <button type="submit" class="btn downloadBtn" id="downloadBtn" style="width: 2.4rem; height: 2.05rem; border: none; border-radius:0; margin-right: -.1rem !important; background-color: #F9F9F9; border: 1.5px solid #DDDDDD; border-top-right-radius: 5px; border-bottom-right-radius: 5px;">
    ...
    <script defer src="<?= ROOT ?>scripts/employeeWeeklyReport.js"></script>
</body>
