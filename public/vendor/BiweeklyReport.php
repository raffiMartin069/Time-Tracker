...
$datas = ['name', 'shift', 'date', 'clockin', 'lunchduration', 'breakduration', 'clockout', 'hoursworked', 'totalbiweeklyhrs'];
...
$totalbiweeklyhrs = $_POST['totalbiweeklyhrs'];  
...
$pdf->Cell(191, 10, $totalbiweeklyhrs, 0, 0, 'R');
$pdf->Ln(5);   
$pdf->SetFont('Arial', 'B', 9);  
$pdf->Cell(191, 10, 'TOTAL BIWEEKLY HOURS', 0, 1, 'R');   
